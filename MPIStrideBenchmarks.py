...
#LAURA END ADD
    #LAURA FuncName='Func'+str(A)+'Stride'+str(Stride)+"Dim"+str(StrideDim)	 
...
#LAURA END ADD
    ...
    if(ConfigParams['alloc'][VarNum]=='d' or ConfigParams['alloc'][VarNum]=='dynamic'):
	    #LAURA FuncDecl='long int Func'+str(A)+'Stride'+str(Stride)+"Dim"+str(StrideDim)+'('+VarFuncDeclString+' long int Stride, int Sum )'
            FuncDecl='long int Func_work'+'('+VarFuncDeclString+' long int Stride, int Sum )'   #LAURA
    else:
    	    #LAURA FuncDecl='long int Func'+str(A)+'Stride'+str(Stride)+"Dim"+str(StrideDim)+'('+VarFuncDeclString+' long int Stride, int Sum )'
            FuncDecl='long int Func_work'+'('+VarFuncDeclString+' long int Stride, int Sum )'   #LAURA
